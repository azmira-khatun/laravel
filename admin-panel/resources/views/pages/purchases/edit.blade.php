        ...
        <form action="{{ route('purchasesUpdate', $purchase->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="product_quantity" id="product_quantity" class="form-control"
                    value="{{ $purchase->product_quantity }}" min="1" required>
            </div>

            <div class="mb-3">
                <label for="product_price" class="form-label">Unit Price</label>
                <input type="number" name="product_price" id="product_price" class="form-control"
                    value="{{ $purchase->product_price }}" step="0.01" required>
            </div>

            <div class="mb-3">
                <label for="subtotal_amount" class="form-label">Subtotal Amount (Auto)</label>
                <input type="number" name="subtotal_amount" id="subtotal_amount" class="form-control"
                    value="{{ $purchase->subtotal_amount }}" step="0.01" readonly>
            </div>

            <div class="mb-3">
                <label for="discount_amount" class="form-label">Discount Amount</label>
                <input type="number" name="discount_amount" id="discount_amount" class="form-control"
                    value="{{ $purchase->discount_amount }}" step="0.01">
            </div>

            <div class="mb-3">
                <label for="tax_amount" class="form-label">Tax Amount</label>
                <input type="number" name="tax_amount" id="tax_amount" class="form-control"
                    value="{{ $purchase->tax_amount }}" step="0.01">
            </div>

            <div class="mb-3">
                <label for="shipping_cost" class="form-label">Shipping Cost</label>
                <input type="number" name="shipping_cost" id="shipping_cost" class="form-control"
                    value="{{ $purchase->shipping_cost }}" step="0.01">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="total_cost" id="total_cost" class="form-control"
                    value="{{ $purchase->total_cost }}" step="0.01" readonly>
            </div>

            <div class="mb-3">
                <label for="paid_amount" class="form-label">Paid Amount</label>
                <input type="number" name="paid_amount" id="paid_amount" class="form-control"
                    value="{{ $purchase->paid_amount }}" step="0.01" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="due_amount" id="due_amount" class="form-control"
                    value="{{ $purchase->due_amount }}" step="0.01" readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="payment_method" id="payment_method" class="form-control" required>
                    ...
                    <option value="Mobile Payment" {{ $purchase->payment_method == 'Mobile Payment' ? 'selected' : '' }}>Mobile Payment</option>
